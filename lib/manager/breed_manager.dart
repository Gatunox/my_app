...
class BreedManager {
  final StreamController<int> _breedCountController =
      StreamController<int>.broadcast();
  Sink get breedCountSink => _breedCountController.sink;
  Stream<int> get breedCountStream => _breedCountController.stream;
  ...
  void listenToBreeeListStream(String query) {
    filteredBreedList(query).listen((list) {
      ...
      breedCountSink.add(list.length);
    }, onDone: () {
